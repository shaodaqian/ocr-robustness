...
def run_all_general(file_name, num_image = 10, core=True, cifar=False, ada=False, onlyrelu=False, skipsigmoid=False):
    if len(file_name.split('_')) == 5:
...
if __name__ == '__main__':
    ...
    LBs, times = run_all_general('model/cnn.h5py', onlyrelu=True, core=False)
    print(LBs, times)
    LB.append(LBs)
    time.append(times)
